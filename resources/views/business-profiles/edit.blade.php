    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('business-profiles.update', $businessProfile) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="business_name" id="business_name" value="{{ old('business_name', $businessProfile->business_name) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="4"
                                      class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-blue-500 focus:ring-blue-500"
                                      required>{{ old('description', $businessProfile->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            @if($businessProfile->logo_path)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $businessProfile->logo_path) }}" alt="Current Logo" class="h-24 w-24 object-cover rounded-lg">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">PNG, JPG, or GIF (max 2MB) - Leave empty to keep current logo</p>
                            @error('logo')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                                ...
                                @foreach($categories as $category)
                                    <label class="flex items-center space-x-2 cursor-pointer">
                                        <input type="checkbox" name="categories[]" value="{{ $category->id }}"
                                               {{ in_array($category->id, old('categories', $businessProfile->categories->pluck('id')->toArray())) ? 'checked' : '' }}
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="address" id="address" value="{{ old('address', $businessProfile->address) }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="state" id="state" value="{{ old('state', $businessProfile->state) }}" placeholder="e.g., CA"
                                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100">
                                    @error('state')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="zip_code" id="zip_code" value="{{ old('zip_code', $businessProfile->zip_code) }}"
                                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100">
                                    @error('zip_code')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="country" id="country" value="{{ old('country', $businessProfile->country) }}"
                                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100">
                                    @error('country')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="phone" id="phone" value="{{ old('phone', $businessProfile->phone) }}"
                                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100">
                                    @error('phone')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="service_radius_miles" id="service_radius_miles" value="{{ old('service_radius_miles', $businessProfile->service_radius_miles) }}" min="0" step="1"
                                   class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100">
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            <a href="{{ route('business-profiles.show', $businessProfile) }}" class="px-4 py-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100">
                                Cancel
                            </a>
